...
val MIGRATION_5_6 =
    object : Migration(5, 6) {
        override fun migrate(db: SupportSQLiteDatabase) {
            db.execSQL("ALTER TABLE tasks ADD COLUMN isCheckedToday INTEGER NOT NULL DEFAULT 0")
        }
    }
...
val MIGRATION_6_7 =
    object : Migration(6, 7) {
        override fun migrate(db: SupportSQLiteDatabase) {
            db.execSQL("ALTER TABLE heroes ADD COLUMN timeZoneId TEXT NOT NULL DEFAULT 'UTC'")
        }
    }

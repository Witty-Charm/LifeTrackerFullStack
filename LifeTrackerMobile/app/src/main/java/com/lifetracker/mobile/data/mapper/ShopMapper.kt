...
fun ShopItemDto.toDomain(): ShopItemDomain = ShopItemDomain(
    id = id,
    name = name,
...
fun BuyResultDto.toDomain(): BuyResult = BuyResult(
    newGold = newGold,
    newHp = newHp,
    maxHp = maxHp,
...
fun PurchasedItemDto.toDomain(): InventoryItemDomain = InventoryItemDomain(
